...
public class HandleException extends ResponseEntityExceptionHandler implements ErrorController {
    @Override
    protected ResponseEntity<Object> handleExceptionInternal(Exception exception, Object body, @NonNull HttpHeaders headers, @NonNull HttpStatusCode statusCode, @NonNull WebRequest request) {
    ...
    public ResponseEntity<HttpResponse> noResultException(NoResultException exception) {
        ...
        return new ResponseEntity<>(
                HttpResponse.builder()
                        ...
                        .developerMessage(exception.getMessage())
                        //.reason(exception.getMessage() + ", too many failed attempts.")
                        .reason("No exist result.")
                        .status(NOT_FOUND)
                        .statusCode(NOT_FOUND.value()).build()
                , NOT_FOUND);
    }
    ...
    public ResponseEntity<HttpResponse> httpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException exception) {
        ...
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
                        .reason(exception.getMessage())
                        .developerMessage(String.format("This request method is not allowed on this endpoint. Please send a '%s' request", supportedMethod))
                        .status(METHOD_NOT_ALLOWED)
                        .statusCode(METHOD_NOT_ALLOWED.value()).build()
                , METHOD_NOT_ALLOWED);
    }*/
    @ExceptionHandler(SignatureException.class)
    public ResponseEntity<HttpResponse> disabledException(SignatureException exception) {
        log.error(exception.getMessage());
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
